...
<th class="blue header <?php
if ($field->isReal() || $field->getConfig('is_sortable', false, false)):
?>[?php if ('<?php echo $name ?>' == $sort[0]):
echo $sort[1]== 'desc' ? 'headerSortDown' : 'headerSortUp';
 endif; ?]<?php endif; ?> sf_admin_<?php echo strtolower($field->getType()) ?> sf_admin_list_th_<?php echo $name ?>">
